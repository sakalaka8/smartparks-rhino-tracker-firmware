...
void lorawan_doneCallback(void)
{
  ...
  adc_battery_sum = 0;
  float stm32l0_battery_low = adc_battery_sum/adc_battery_count*4.0/4095; // TODO: calibrate
  status_packet.data.battery_low=(uint8_t)get_bits(stm32l0_battery_low,0,4,8);
